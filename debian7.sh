...
# set repo
wget -q -O /etc/apt/sources.list https://raw.githubusercontent.com/Third10/debian/master/sources.list.debian7
...
# install screenfetch
cd
wget https://raw.githubusercontent.com/Third10/debian/master/screenfetch-dev
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/Third10/debian/master/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by Ibnu Fachrizal</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/Third10/debian/master/vps.conf"
...
#install ovpn
cd
wget -q https://raw.githubusercontent.com/Third10/debian/master/openvpn.sh
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/Third10/debian/master/badvpn-udpgw64"
...
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/Third10/debian/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/Third10/debian/master/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/Third10/debian/master/mrtg.conf" >> /etc/mrtg.cfg
...
wget https://raw.githubusercontent.com/Third10/debian/master/vnstat_php_frontend-1.5.1.tar.gz
...
# User Status
cd
wget https://raw.githubusercontent.com/Third10/debian/master/user-list.sh
mv ./user-list.sh /usr/local/bin/user-list.sh
chmod +x /usr/local/bin/user-list.sh

# Install Dos Deflate
apt-get -y install dnsutils dsniff
wget https://raw.githubusercontent.com/Third10/debian/master/ddos-deflate-master.zip
...
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/userdetail.sh
...
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/autokilluser.sh
mv ./autokilluser.sh /usr/bin/autokilluser.sh
chmod +x /usr/bin/autokilluser.sh

# instal  Kill Multi Login2
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/autokill.sh
...
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/userunban.sh
mv ./userunban.sh /usr/bin/userunban.sh
chmod +x /usr/bin/userunban.sh

# instal Mengunci Akun SSH & OpenVPN
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/userlock.sh
mv ./userlock.sh /usr/bin/userlock.sh
chmod +x /usr/bin/userlock.sh

# instal Membuka user SSH & OpenVPN yang terkunci
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/userunlock.sh
...
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/loglimit.sh
...
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/logban.sh
mv ./logban.sh /usr/bin/logban.sh
chmod +x /usr/bin/logban.sh

# instal Set Auto Reboot
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/autoreboot.sh
...
wget https://raw.githubusercontent.com/Third10/debian/master/config/speedtest.py.sh
...
# instal diagnosa
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/diagnosa.sh
mv ./diagnosa.sh /usr/bin/diagnosa.sh
chmod +x /usr/bin/diagnosa.sh

# instal ram
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/ram.sh
mv ./ram.sh /usr/bin/ram.sh
chmod +x /usr/bin/ram.sh

# log install
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/log-install.sh
mv ./log-install.sh /usr/bin/log-install.sh
chmod +x /usr/bin/log-install.sh

# edit ubah-port
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/ubahport.sh
mv ./ubahport.sh /usr/bin/ubahport.sh
chmod +x /usr/bin/ubahport.sh

# edit-port-dropbear
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/edit-port-dropbear.sh
mv ./edit-port-dropbear.sh /usr/bin/edit-port-dropbear.sh
chmod +x /usr/bin/edit-port-dropbear.sh

# edit-port-openssh
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/edit-port-openssh.sh
mv ./edit-port-openssh.sh /usr/bin/edit-port-openssh.sh
chmod +x /usr/bin/edit-port-openssh.sh

# edit-port-openvpn
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/edit-port-openvpn.sh
mv ./edit-port-openvpn.sh /usr/bin/edit-port-openvpn.sh
chmod +x /usr/bin/edit-port-openvpn.sh

# edit-port-openvpn
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/edit-port-squid.sh
mv ./edit-port-squid.sh /usr/bin/edit-port-squid.sh
chmod +x /usr/bin/edit-port-squid.sh

# restart
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/restart.sh
mv ./restart.sh /usr/bin/restart.sh
chmod +x /usr/bin/restart.sh

# restart-dropbear
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/restart-dropbear.sh
mv ./restart-dropbear.sh /usr/bin/restart-dropbear.sh
chmod +x /usr/bin/restart-dropbear.sh

# restart-squid
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/restart-squid.sh
mv ./restart-squid.sh /usr/bin/restart-squid.sh
chmod +x /usr/bin/restart-squid.sh

# restart-openvpn
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/restart-openvpn.sh
mv ./restart-openvpn.sh /usr/bin/restart-openvpn.sh
chmod +x /usr/bin/restart-openvpn.sh

# restart-webmin
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/restart-webmin.sh
mv ./restart-webmin.sh /usr/bin/restart-webmin.sh
chmod +x /usr/bin/restart-webmin.sh

# disable-user-expire
cd
wget https://raw.githubusercontent.com/Third10/debian/master/config/disable-user-expire.sh
mv ./disable-user-expire.sh /usr/bin/disable-user-expire.sh
chmod +x /usr/bin/disable-user-expire.sh

# bannerssh
wget https://raw.githubusercontent.com/Third10/debian/master/config/bannerssh
...
# Install Menu
cd
wget https://raw.githubusercontent.com/Third10/debian/master/menu
mv ./menu /usr/local/bin/menu
chmod +x /usr/local/bin/menu

# download script
cd
wget -q -O /usr/bin/welcomeadmin https://raw.githubusercontent.com/Third10/debian/master/welcome.sh
wget -O /etc/bannerssh "https://raw.githubusercontent.com/Third10/debian/master/config/bannerssh"
...
echo ""  | tee -a log-install.txt
echo "VPS REBOOT เวลา 00.00 !"  | tee -a log-install.txt
echo""  | tee -a log-install.txt
echo "Please Reboot your VPS !"  | tee -a log-install.txt
echo "------------------------------------------------------------"  | tee -a log-install.txt
echo "Modified by THIRD"  | tee -a log-install.txt
cd ~/
